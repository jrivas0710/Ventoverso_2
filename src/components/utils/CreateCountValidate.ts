...
export const CreateCountValidate = yup.object().shape({
    ...
    email: yup.string().trim().email("Correo inválido").required("Este campo es requerido"),/* .min(4, "El mínimo debe ser de cuatro caracteres").max(20,"El máximo debe ser de 20 caracteres") */
